    ...
    <div className="min-h-screen home-page" id="especialidades">
      ...
      >
        <div className="container relative pb-8 pl-12 my-10">
          <h1 className="text-3xl text-gray-900 mb-4">ESPECIALIDADES</h1>
          <div className="flex justify-between items-center">
            <ul
              className="list-disc pl-12 py-6 bg-teal-700 text-white font-medium rounded-lg mb-4 w-1/2 relative bg-ul-specialties"
              data-aos="fade-right"
            ...
            <div
              className="flex w-1/2 justify-center items-center relative"
              data-aos="zoom-in"
              data-aos-duration="2500"
            >
              <button className="text-white text-xl font-semibold border-4 border-violet-700 bg-violet-700 px-4 py-1 rounded-md hover:bg-violet-700 hover:scale-110 duration-300">
                Más información
              </button>
            </div>
          </div>
